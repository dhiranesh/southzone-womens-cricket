      ...
      <div className="p-4 space-y-4">
        ...
        <Card className="p-4 bg-destructive/5 border-destructive/20">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground">Emergency Transport</p>
        ...
        <h2 className="text-lg font-semibold text-foreground">Official Transport</h2>
          ...
          {officialTransport.map((transport) => (
            <Card key={transport.id} className="p-4">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">{transport.route}</h3>
                  <p className="text-xs text-muted-foreground">{transport.vehicle}</p>
                </div>
              </div>
              ...
              <div className="space-y-2 mb-4">
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>Timings: {transport.timing}</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  <MapPin className="h-4 w-4" />
                  <span>Driver: {transport.driver}</span>
                </div>
              </div>
        ...
        <h2 className="text-lg font-semibold text-foreground mt-6">How to Reach</h2>
        
        <Card className="p-4">
          <div className="space-y-4">
            <div>
              <h4 className="font-medium text-foreground mb-1">By Train</h4>
              <p className="text-sm text-muted-foreground">
                Nearest station: Tiruchengode (8 km). Pickup available on request.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-foreground mb-1">By Bus</h4>
              <p className="text-sm text-muted-foreground">
                KSRTC buses available from major cities. Drop at Tiruchengode Bus Stand.
              </p>
            </div>
            <div>
              <h4 className="font-medium text-foreground mb-1">By Air</h4>
              <p className="text-sm text-muted-foreground">
